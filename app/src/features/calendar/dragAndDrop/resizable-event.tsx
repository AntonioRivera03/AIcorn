    ...
    >
      ...
      {isResizing && resizePreview && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -10 }}
          className="absolute -top-8 left-1/2 z-50 transform -translate-x-1/2 whitespace-nowrap rounded border border-border bg-popover px-2 py-1 text-xs text-popover-foreground shadow-lg"
        >
